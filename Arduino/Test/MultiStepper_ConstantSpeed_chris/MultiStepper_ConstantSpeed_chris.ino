...
const long stepper2TimeToComplete = 20;  // s
...
//      }
    ...
    //Serial.println(String(currentTimeStamp * 0.001, DEC) + ", " + String(stepper1CurrPos, DEC) + ", " + String(stepper1.speed(), DEC));
...
//      }
    ...
    //Serial.println(String(currentTimeStamp * 0.001, DEC) + ", " + String(stepper2CurrPos, DEC) + ", " + String(stepper2.speed(), DEC));
    ...
    Serial.println(
      String(currentTimeStamp, DEC) + ", " +
      String(stepper1CurrPos, DEC) + ", " +
      String(stepper1.speed(), DEC) + ", " +
      String(stepper2CurrPos, DEC) + ", " +
